...
import com.cristi.mentool.mentoolfront.infra.security.JwtAuthenticationEntryPoint;
import com.cristi.mentool.mentoolfront.infra.security.JwtAuthenticationFilter;
...
public class JwtWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] ALLOWED_ENDPOINTS = {"/",
            ...
            "/api/token/generate-token", "/api/token/**", "/login/**", "/**/login/**", "/api/users",
